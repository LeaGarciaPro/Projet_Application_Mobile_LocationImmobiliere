...
public class CompteProActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_compte_pro);
        ...
        //Bouton de modification de l'abonnement
        Button button_modif_abonnement = findViewById(R.id.button_modif_abonnement);
        button_modif_abonnement.setOnClickListener(view -> {
            Intent modif_abonn = new Intent(getApplicationContext(), ModificationAbonnementActivity.class);
            startActivity(modif_abonn);
            overridePendingTransition(0,0);
            finish();
        });
